...
class IFLAType(IntEnum):
    ...
    PRIORITY: Final = 9
    MASTER: Final = 10
    WIRELESS: Final = 11  # Wireless Extension event - see wireless.h
    PROTINFO: Final = 12  # Protocol specific information for a link
    TXQLEN: Final = 13
    MAP: Final = 14
    WEIGHT: Final = 15
    OPERSTATE: Final = 16
    ...
    NET_NS_PID: Final = 19
    IFALIAS: Final = 20
    NUM_VF: Final = 21  # Number of VFs if device is SR-IOV PF
    VFINFO_LIST: Final = 22
    STATS64: Final = 23
    VF_PORTS: Final = 24
    PORT_SELF: Final = 25
    AF_SPEC: Final = 26
    GROUP: Final = 27  # Group the device belongs to
    NET_NS_FD: Final = 28
    EXT_MASK: Final = 29  # Extended info mask: Final = 0 VFs: Final = 0 etc
    PROMISCUITY: Final = 30  # Promiscuity count: > 0 means acts PROMISC
