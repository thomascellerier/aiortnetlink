...
# See <uapi/linux/fib_rules.h>
class FRAType(IntEnum):
    FRA_UNSPEC: Final = 0
    FRA_DST: Final = 1  # destination address
    FRA_SRC: Final = 2  # source address
    FRA_IIFNAME: Final = 3  # interface name
    FRA_GOTO: Final = 4  # target to jump to (FR_ACT_GOTO)
    FRA_UNUSED2: Final = 5
    FRA_PRIORITY: Final = 6  # priority/preference
    FRA_UNUSED3: Final = 7
    FRA_UNUSED4: Final = 8
    FRA_UNUSED5: Final = 9
    FRA_FWMARK: Final = 10  # mark
    FRA_FLOW: Final = 11  # flow/class id
    FRA_UNUSED6: Final = 12
    FRA_SUPPRESS_IFGROUP: Final = 12
    FRA_SUPPRESS_PREFIXLEN: Final = 13
    FRA_TABLE: Final = 14  # Extended table id
    FRA_FWMASK: Final = 15  # mask for netfilter mark
    FRA_OIFNAME: Final = 16
    FRA_UID_START: Final = 17  # UID range
